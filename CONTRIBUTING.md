Contributing to Hootchain Core
============================

The Hootchain Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Hootchain Core
...
Before you start contributing, familiarize yourself with the Hootchain Core build
system and tests. Refer to the documentation in the repository on how to build
Hootchain Core and how to run the unit and functional tests.
...
Most communication about Hootchain Core development happens on Discord Server.
...
fork of Hootchain Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Hootchain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Hootchain
Network Protocol consensus changes.

Whether a pull request is merged into Hootchain Core rests with the project merge
...
Patches that change Hootchain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hootchain consensus, it must have been
...
The review process is normally fairly responsive on the Hootchain Core repository, however
...
Bitcoin Backports are an incredibly valuable part of Hootchain's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for Hootchain](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each Hootchain Core release.
