...
Arguments:
    <base_directory> - The base directory of a Hootchain Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Hootchain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Hootchain Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Hootchain
