# Bootstrappable Hootchain Core Builds

This directory contains the files necessary to perform bootstrappable Hootchain
Core builds.
...
To build Hootchain Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Hootchain Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/hoot-detached-sigs> ./contrib/guix/guix-codesign
```
