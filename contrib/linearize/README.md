# Linearize
Construct a linear, no-fork, best version of the Hootchain blockchain.
...
JSON-RPC server. Running `hootd` or `hoot-qt -server` will be sufficient.
...
* `input`: hootd blocks/ directory containing blkNNNNN.dat
