# Support for Output Descriptors in Hootchain Core

Since Hootchain Core v0.17, there is support for Output Descriptors. This is a
...
existing Hootchain Core wallets, a convenience function `combo` is
...
All RPCs in Hootchain Core will include the checksum in their output. Only
