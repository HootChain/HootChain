...
This mechanism has been integrated into Bitcore-Node-Hootchain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-hoot#web-socket-api](https://github.com/dashpay/insight-api-hoot#web-socket-api)
* API: [https://github.com/dashpay/insight-api-hoot#instantsend-transactions](https://github.com/dashpay/insight-api-hoot#instantsend-transactions)
