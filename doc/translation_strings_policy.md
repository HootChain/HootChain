...
This document provides guidelines for internationalization of the Hootchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hoot_en.ts` remains unchanged.
