...
#ifndef HOOT_CRYPTO_BLS_H
#define HOOT_CRYPTO_BLS_H
...
// bls-hoot uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
