...
public:
    CMainParams() {
        ...
        // Hootchain addresses start with 'S'
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Hootchain: 1 day
        consensus.nPowTargetSpacing = 90; // Hootchain: 90 seconds for testnet
        ...
        vSeeds.emplace_back("testnet-seed.hoot.space"); // Just a static list of stable node(s), only supports x9

        // Testnet Hootchain addresses start with 's'
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("hoot.space",  "devnet-seed.hoot.space"));
