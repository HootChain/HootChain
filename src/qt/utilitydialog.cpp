    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  hoot-qt [command-line options]                     \n";
...
All the Hootchain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 HOOT, 0.01 HOOT, 0.1 HOOT, 1 HOOT and 10 HOOT -- sort of like the paper money you use every day.</li> \
