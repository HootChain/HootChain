...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"hoot\" activates all Hootchain-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "hoot")
    + HelpExampleRpc("debug", "hoot+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Hootchain address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Hootchain address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "hoot-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Hootchain features */
    { "hoot",               "mnsync",                 &mnsync,                 {} },
    { "hoot",               "spork",                  &spork,                  {"command"} },
    { "hoot",               "sporkupdate",            &sporkupdate,            {"name","value"} },
