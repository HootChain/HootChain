...
"""Verify that starting hootd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hootd with -h for help text")
        ...
        self.log.info("Start hootd with -version for version information")
        ...
        self.log.info("Start hootdd with -fakearg to make sure it does not start")
