...
"""Test the hoot specific ZMQ notification interfaces."""
...
class HootchainZMQTest (HootchainTestFramework):
    def set_test_params(self):
        ...
        self.set_hoot_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that hootd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all hoot related ZMQ publisher
