...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Hootchain's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Hootchain', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
